...
@section('content')
<div class="space-y-8">
    <h3 class="text-2xl font-bold text-gray-800 mb-4">{{ $type }} Rooms</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-xl transition-transform transform hover:scale-105">
            ...
            <div class="p-4">
                <a href="{{ route('frontdesk.bookings.create', ['room_id' => $room->id]) }}" class="btn btn-lg btn-primary w-full mt-4">
