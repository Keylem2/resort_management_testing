...
@section('title', 'Employee Management | Bluebelle Resort')
...
<div class="container mx-auto p-6">
    <div class="bg-white rounded-xl shadow-lg p-8">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('hr.employees.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">
            ...
            <tbody>
                @foreach ($employees as $employee)
                    <tr class="border-b border-gray-200 bg-white hover:bg-gray-100 text-gray-700">
                        <td class="py-3 px-6">{{ $employee->employee_code }}</td>
